...
#ONDEWO_NLU_API_GIT_BRANCH=tags/6.12.0
ONDEWO_NLU_API_GIT_BRANCH=feature/OND211-2417-ragflow-make-clickable-links-to-web-pages-when-the-references-are-returned-in-the-chat-message
