...
def test_search_intent(term: str) -> FullTextSearchResponseIntent:
    return client.services.agents.get_full_text_search_intent(request=get_request(term=term))


def test_search_intent_context_in(term: str) -> FullTextSearchResponseIntentContextIn:
    return client.services.agents.get_full_text_search_intent_context_in(request=get_request(term=term))


def test_search_intent_context_out(term: str) -> FullTextSearchResponseIntentContextOut:
    return client.services.agents.get_full_text_search_intent_context_out(request=get_request(term=term))


def test_search_intent_usersays(term: str) -> FullTextSearchResponseIntentUsersays:
    return client.services.agents.get_full_text_search_intent_usersays(request=get_request(term=term))


def test_search_intent_tags(term: str) -> FullTextSearchResponseIntentTags:
    return client.services.agents.get_full_text_search_intent_tags(request=get_request(term=term))


def test_search_intent_response(term: str) -> FullTextSearchResponseIntentResponse:
    return client.services.agents.get_full_text_search_intent_response(request=get_request(term=term))


def test_search_intent_parameters(term: str) -> FullTextSearchResponseIntentParameters:
    return client.services.agents.get_full_text_search_intent_parameters(request=get_request(term=term))


def test_search_entity_type(term: str) -> FullTextSearchResponseEntityType:
    return client.services.agents.get_full_text_search_entity_type(request=get_request(term=term))


def test_search_entity(term: str) -> FullTextSearchResponseEntity:
    return client.services.agents.get_full_text_search_entity(request=get_request(term=term))


def test_search_entity_synonym(term: str) -> FullTextSearchResponseEntitySynonym:
    return client.services.agents.get_full_text_search_entity_synonym(request=get_request(term=term))
