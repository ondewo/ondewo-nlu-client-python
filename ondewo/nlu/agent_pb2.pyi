...
class _AgentViewEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_AgentView.V], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    AGENT_VIEW_UNSPECIFIED = AgentView.V(0)
...
class _InitiationProtocol:
    V = typing.NewType('V', builtins.int)
class _InitiationProtocolEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_InitiationProtocol.V], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    AS_SOON_AS_POSSIBLE = InitiationProtocol.V(0)
    """after cache successfully built and after each model trained the agent will be updated"""

    WHEN_TRAINED = InitiationProtocol.V(1)
    """after cache successfully built and all the active models successfully trained"""

    NEVER = InitiationProtocol.V(2)
    """do not initiate"""
...
class _ReportFormat:
    V = typing.NewType('V', builtins.int)
class _ReportFormatEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ReportFormat.V], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    CSV = ReportFormat.V(0)
    HTML = ReportFormat.V(1)
    JSON = ReportFormat.V(2)
...
class _AgentStatus:
    V = typing.NewType('V', builtins.int)
class _AgentStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_AgentStatus.V], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    ACTIVE = AgentStatus.V(0)
    """If project is active, all its endpoints are active"""

    INACTIVE = AgentStatus.V(1)
...
class CreateAgentRequest(google.protobuf.message.Message):
    ...
    @property
    def agent(self) -> global___Agent: ...
    agent_view: global___AgentView.V = ...
...
class TrainAgentRequest(google.protobuf.message.Message):
    ...
    branch: typing.Text = ...
    initiation_protocol: global___InitiationProtocol.V = ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        branch : typing.Text = ...,
...
class GetAgentStatisticsRequest(google.protobuf.message.Message):
    ...
    format: global___ReportFormat.V = ...
    language_code: typing.Text = ...
    type: global___ReportType.V = ...
    def __init__(self,
        *,
        parent : typing.Text = ...,
        format : global___ReportFormat.V = ...,
...
class AgentSorting(google.protobuf.message.Message):
    ...
    class _AgentSortingField:
        V = typing.NewType('V', builtins.int)
    class _AgentSortingFieldEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_AgentSortingField.V], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
        NO_AGENT_SORTING = AgentSorting.AgentSortingField.V(0)
        SORT_AGENT_BY_NAME = AgentSorting.AgentSortingField.V(1)
        SORT_AGENT_BY_CREATION_DATE = AgentSorting.AgentSortingField.V(2)
        SORT_AGENT_BY_LAST_UPDATED = AgentSorting.AgentSortingField.V(3)
        SORT_AGENT_BY_OWNER_NAME = AgentSorting.AgentSortingField.V(4)
    ...
    sorting_field: global___AgentSorting.AgentSortingField.V = ...
...
class ModelStatus(google.protobuf.message.Message):
    ...
    class _StatusName:
        V = typing.NewType('V', builtins.int)
    class _StatusNameEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_StatusName.V], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
        UNKNOWN = ModelStatus.StatusName.V(0)
        INITIALIZING = ModelStatus.StatusName.V(1)
        INITIALIZED = ModelStatus.StatusName.V(2)
        LOADING_DATA = ModelStatus.StatusName.V(3)
        TRAINING = ModelStatus.StatusName.V(4)
        TESTING = ModelStatus.StatusName.V(5)
        TRAINED = ModelStatus.StatusName.V(6)
    ...
    config: typing.Text = ...
    status: global___ModelStatus.StatusName.V = ...
    def __init__(self,
        *,
        cache_version : builtins.int = ...,
        language_code : typing.Text = ...,
...
class CustomPlatformInfo(google.protobuf.message.Message):
    ...
    platform: ondewo.nlu.intent_pb2.Intent.Message.Platform.V = ...
