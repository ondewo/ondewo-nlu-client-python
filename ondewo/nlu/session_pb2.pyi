...
class _AudioEncodingEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_AudioEncoding.V], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    AUDIO_ENCODING_UNSPECIFIED = AudioEncoding.V(0)
    """Not specified."""

    AUDIO_ENCODING_LINEAR_16 = AudioEncoding.V(1)
    """Uncompressed 16-bit signed little-endian samples (Linear PCM)."""

    AUDIO_ENCODING_FLAC = AudioEncoding.V(2)
    ...
    AUDIO_ENCODING_MULAW = AudioEncoding.V(3)
    """8-bit samples that compand 14-bit audio samples using G.711 PCMU/mu-law."""

    AUDIO_ENCODING_AMR = AudioEncoding.V(4)
    """Adaptive Multi-Rate Narrowband codec. `sample_rate_hertz` must be 8000."""

    AUDIO_ENCODING_AMR_WB = AudioEncoding.V(5)
    """Adaptive Multi-Rate Wideband codec. `sample_rate_hertz` must be 16000."""

    AUDIO_ENCODING_OGG_OPUS = AudioEncoding.V(6)
    """Opus encoded audio frames in Ogg container
    ([OggOpus](https://wiki.xiph.org/OggOpus)).
    `sample_rate_hertz` must be 16000.
    """

    AUDIO_ENCODING_SPEEX_WITH_HEADER_BYTE = AudioEncoding.V(7)
...
class StreamingRecognitionResult(google.protobuf.message.Message):
    ...
    *  for `MESSAGE_TYPE_END_OF_SINGLE_UTTERANCE`: only `event_type`.
    ...
    class _MessageTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_MessageType.V], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
        MESSAGE_TYPE_UNSPECIFIED = StreamingRecognitionResult.MessageType.V(0)
        """Not specified. Should never be used."""

        TRANSCRIPT = StreamingRecognitionResult.MessageType.V(1)
        """Message contains a (possibly partial) transcript."""

        END_OF_SINGLE_UTTERANCE = StreamingRecognitionResult.MessageType.V(2)
    ...
    message_type: global___StreamingRecognitionResult.MessageType.V = ...
...
class InputAudioConfig(google.protobuf.message.Message):
    ...
    audio_encoding: global___AudioEncoding.V = ...
...
class Session(google.protobuf.message.Message):
    ...
    class _View:
        V = typing.NewType('V', builtins.int)
    class _ViewEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_View.V], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
        VIEW_UNSPECIFIED = Session.View.V(0)
        """Endpoints decide whether to return the full or the sparse view"""

        VIEW_FULL = Session.View.V(1)
        """All fields are populated."""

        VIEW_SPARSE = Session.View.V(2)
...
class TrackSessionStepRequest(google.protobuf.message.Message):
    ...
    session_view: global___Session.View.V = ...
    def __init__(self,
        *,
        session_id : typing.Text = ...,
...
class SessionInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["earliest",b"earliest","labels",b"labels","language_codes",b"language_codes","latest",b"latest","matched_entity_types",b"matched_entity_types","matched_intents",b"matched_intents","min_entity_types_confidence",b"min_entity_types_confidence","min_intents_confidence",b"min_intents_confidence","number_turns",b"number_turns","user_ids",b"user_ids"]) -> None: ...
...
class CreateSessionReviewRequest(google.protobuf.message.Message):
    ...
    def session_review(self) -> global___SessionReview:
        ...
        pass
    session_review_view: global___SessionReview.View.V = ...
    def __init__(self,
        *,
        session_id : typing.Text = ...,
        parent_review_id : typing.Text = ...,
...
class SessionReview(google.protobuf.message.Message):
    ...
    class _ViewEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_View.V], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
        VIEW_UNSPECIFIED = SessionReview.View.V(0)
        """Endpoints decide whether to return the full or the sparse view"""

        VIEW_FULL = SessionReview.View.V(1)
        """All fields are populated."""

        VIEW_SPARSE = SessionReview.View.V(2)
        """Only some fields are populated in the response."""
