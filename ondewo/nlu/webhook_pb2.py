...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _WEBHOOK.methods_by_name[
        'ResponseRefinement']._serialized_options = b'\202\323\344\223\002>\"9/{session=projects/*/agent/sessions/*}:responseRefinement:\001*'
    _WEBHOOK.methods_by_name['SlotFilling']._options = None
    _WEBHOOK.methods_by_name[
        'SlotFilling']._serialized_options = b'\202\323\344\223\0027\"2/{session=projects/*/agent/sessions/*}:slotFilling:\001*'
