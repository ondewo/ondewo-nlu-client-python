...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _PROJECTSTATISTICS.methods_by_name[
        'GetIntentCount']._serialized_options = b'\202\323\344\223\002*\022(/{parent=projects/*/agent}/intents:count'
    _PROJECTSTATISTICS.methods_by_name['GetEntityTypeCount']._options = None
    _PROJECTSTATISTICS.methods_by_name[
        'GetEntityTypeCount']._serialized_options = b'\202\323\344\223\002.\022,/{parent=projects/*/agent}/entityTypes:count'
    _PROJECTSTATISTICS.methods_by_name['GetUserCount']._options = None
    _PROJECTSTATISTICS.methods_by_name[
        'GetUserCount']._serialized_options = b'\202\323\344\223\002(\022&/{parent=projects/*/agent}/users:count'
    _PROJECTSTATISTICS.methods_by_name['GetSessionCount']._options = None
    _PROJECTSTATISTICS.methods_by_name[
        'GetSessionCount']._serialized_options = b'\202\323\344\223\002+\022)/{parent=projects/*/agent}/sessions:count'
    _PROJECTSTATISTICS.methods_by_name['GetTrainingPhraseCount']._options = None
    _PROJECTSTATISTICS.methods_by_name[
        'GetTrainingPhraseCount']._serialized_options = b'\202\323\344\223\002:\0228/{name=projects/*/agent/intents/*}/trainingPhrases:count'
    _PROJECTSTATISTICS.methods_by_name['GetResponseCount']._options = None
    _PROJECTSTATISTICS.methods_by_name[
        'GetResponseCount']._serialized_options = b'\202\323\344\223\0024\0222/{name=projects/*/agent/intents/*}/responses:count'
    _PROJECTSTATISTICS.methods_by_name['GetEntityValueCount']._options = None
    _PROJECTSTATISTICS.methods_by_name[
        'GetEntityValueCount']._serialized_options = b'\202\323\344\223\0027\0225/{name=projects/*/agent/entityTypes/*}/entities:count'
    _PROJECTSTATISTICS.methods_by_name['GetEntitySynonymCount']._options = None
    _PROJECTSTATISTICS.methods_by_name[
        'GetEntitySynonymCount']._serialized_options = b'\202\323\344\223\002L\022J/{name=projects/*/agent/entityTypes/*/entityValues/*}/entitySynonyms:count'
