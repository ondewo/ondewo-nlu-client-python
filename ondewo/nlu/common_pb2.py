...
_CREATEDMODIFIED = DESCRIPTOR.message_types_by_name['CreatedModified']
...
CreatedModified = _reflection.GeneratedProtocolMessageType('CreatedModified', (_message.Message,), {
  'DESCRIPTOR' : _CREATEDMODIFIED,
  '__module__' : 'ondewo.nlu.common_pb2'
  # @@protoc_insertion_point(class_scope:ondewo.nlu.CreatedModified)
  })
_sym_db.RegisterMessage(CreatedModified)

if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _SORTINGMODE._serialized_start=171
  _SORTINGMODE._serialized_end=215
  _STATRESPONSE._serialized_start=39
  _STATRESPONSE._serialized_end=68
  _CREATEDMODIFIED._serialized_start=70
  _CREATEDMODIFIED._serialized_end=169
