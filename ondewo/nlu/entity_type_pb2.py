...
_CREATEENTITYREQUEST = _descriptor.Descriptor(
  ...
  full_name='ondewo.nlu.CreateEntityRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='entity_type_name', full_name='ondewo.nlu.CreateEntityRequest.entity_type_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='entity', full_name='ondewo.nlu.CreateEntityRequest.entity', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATEENTITYREQUEST = _descriptor.Descriptor(
  ...
  full_name='ondewo.nlu.UpdateEntityRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='entity', full_name='ondewo.nlu.UpdateEntityRequest.entity', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETENTITYREQUEST = _descriptor.Descriptor(
  ...
  full_name='ondewo.nlu.GetEntityRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='ondewo.nlu.GetEntityRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DELETEENTITYREQUEST = _descriptor.Descriptor(
  ...
  full_name='ondewo.nlu.DeleteEntityRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='ondewo.nlu.DeleteEntityRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATEENTITYREQUEST.fields_by_name['entity'].message_type = _ENTITYTYPE_ENTITY
_UPDATEENTITYREQUEST.fields_by_name['entity'].message_type = _ENTITYTYPE_ENTITY
...
_ENTITYTYPES = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='CreateEntity',
    full_name='ondewo.nlu.EntityTypes.CreateEntity',
    index=10,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='UpdateEntity',
    full_name='ondewo.nlu.EntityTypes.UpdateEntity',
    index=11,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetEntity',
    full_name='ondewo.nlu.EntityTypes.GetEntity',
    index=12,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='DeleteEntity',
    full_name='ondewo.nlu.EntityTypes.DeleteEntity',
    index=13,
    containing_service=None,
