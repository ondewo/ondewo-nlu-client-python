...
_ENTITYTYPE_ENTITY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='language_code', full_name='ondewo.nlu.EntityType.Entity.language_code', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='display_name', full_name='ondewo.nlu.EntityType.Entity.display_name', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='synonym_count', full_name='ondewo.nlu.EntityType.Entity.synonym_count', index=5,
...
_CREATEENTITYVALUEREQUEST = _descriptor.Descriptor(
  name='CreateEntityValueRequest',
  full_name='ondewo.nlu.CreateEntityValueRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='ondewo.nlu.CreateEntityValueRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='entity', full_name='ondewo.nlu.CreateEntityValueRequest.entity', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATEENTITYVALUEREQUEST = _descriptor.Descriptor(
  name='UpdateEntityValueRequest',
  full_name='ondewo.nlu.UpdateEntityValueRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='entity', full_name='ondewo.nlu.UpdateEntityValueRequest.entity', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETENTITYVALUEREQUEST = _descriptor.Descriptor(
  name='GetEntityValueRequest',
  full_name='ondewo.nlu.GetEntityValueRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='ondewo.nlu.GetEntityValueRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DELETEENTITYVALUEREQUEST = _descriptor.Descriptor(
  name='DeleteEntityValueRequest',
  full_name='ondewo.nlu.DeleteEntityValueRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='ondewo.nlu.DeleteEntityValueRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATEENTITYVALUEREQUEST.fields_by_name['entity'].message_type = _ENTITYTYPE_ENTITY
_UPDATEENTITYVALUEREQUEST.fields_by_name['entity'].message_type = _ENTITYTYPE_ENTITY
...
DESCRIPTOR.message_types_by_name['CreateEntityValueRequest'] = _CREATEENTITYVALUEREQUEST
DESCRIPTOR.message_types_by_name['UpdateEntityValueRequest'] = _UPDATEENTITYVALUEREQUEST
DESCRIPTOR.message_types_by_name['GetEntityValueRequest'] = _GETENTITYVALUEREQUEST
DESCRIPTOR.message_types_by_name['DeleteEntityValueRequest'] = _DELETEENTITYVALUEREQUEST
...
CreateEntityValueRequest = _reflection.GeneratedProtocolMessageType('CreateEntityValueRequest', (_message.Message,), {
  ...
  '__module__' : 'ondewo.nlu.entity_type_pb2'
  # @@protoc_insertion_point(class_scope:ondewo.nlu.CreateEntityValueRequest)
  })
...
UpdateEntityValueRequest = _reflection.GeneratedProtocolMessageType('UpdateEntityValueRequest', (_message.Message,), {
  ...
  '__module__' : 'ondewo.nlu.entity_type_pb2'
  # @@protoc_insertion_point(class_scope:ondewo.nlu.UpdateEntityValueRequest)
  })
_sym_db.RegisterMessage(UpdateEntityValueRequest)

GetEntityValueRequest = _reflection.GeneratedProtocolMessageType('GetEntityValueRequest', (_message.Message,), {
  'DESCRIPTOR' : _GETENTITYVALUEREQUEST,
  '__module__' : 'ondewo.nlu.entity_type_pb2'
  # @@protoc_insertion_point(class_scope:ondewo.nlu.GetEntityValueRequest)
  })
_sym_db.RegisterMessage(GetEntityValueRequest)
...
DeleteEntityValueRequest = _reflection.GeneratedProtocolMessageType('DeleteEntityValueRequest', (_message.Message,), {
  ...
  '__module__' : 'ondewo.nlu.entity_type_pb2'
  # @@protoc_insertion_point(class_scope:ondewo.nlu.DeleteEntityValueRequest)
  })
...
_ENTITYTYPES = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='ondewo.nlu.EntityTypes.CreateEntityValue',
    index=10,
    containing_service=None,
    input_type=_CREATEENTITYVALUEREQUEST,
    output_type=_ENTITYTYPE_ENTITY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='UpdateEntityValue',
    full_name='ondewo.nlu.EntityTypes.UpdateEntityValue',
    index=11,
    containing_service=None,
    input_type=_UPDATEENTITYVALUEREQUEST,
    output_type=_ENTITYTYPE_ENTITY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetEntityValue',
    full_name='ondewo.nlu.EntityTypes.GetEntityValue',
    index=12,
    containing_service=None,
    input_type=_GETENTITYVALUEREQUEST,
    output_type=_ENTITYTYPE_ENTITY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='DeleteEntityValue',
    full_name='ondewo.nlu.EntityTypes.DeleteEntityValue',
    index=13,
    containing_service=None,
    input_type=_DELETEENTITYVALUEREQUEST,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
