...
_BATCHCREATEENTITIESREQUEST_CREATEENTITYREQUEST = _BATCHCREATEENTITIESREQUEST.nested_types_by_name[
    'CreateEntityRequest']
...
_BATCHDELETEENTITIESRESPONSE_DELETEENTITYSTATUS = _BATCHDELETEENTITIESRESPONSE.nested_types_by_name[
    'DeleteEntityStatus']
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _ENTITYTYPES.methods_by_name[
        'ListEntityTypes']._serialized_options = b'\202\323\344\223\002+\022)/v2/{parent=projects/*/agent}/entityTypes'
    _ENTITYTYPES.methods_by_name['GetEntityType']._options = None
    _ENTITYTYPES.methods_by_name[
        'GetEntityType']._serialized_options = b'\202\323\344\223\002+\022)/v2/{name=projects/*/agent/entityTypes/*}'
    _ENTITYTYPES.methods_by_name['CreateEntityType']._options = None
    _ENTITYTYPES.methods_by_name[
        'CreateEntityType']._serialized_options = b'\202\323\344\223\002.\")/v2/{parent=projects/*/agent}/entityTypes:\001*'
    _ENTITYTYPES.methods_by_name['UpdateEntityType']._options = None
    _ENTITYTYPES.methods_by_name[
        'UpdateEntityType']._serialized_options = b'\202\323\344\223\002:25/v2/{entity_type.name=projects/*/agent/entityTypes/*}:\001*'
    _ENTITYTYPES.methods_by_name['DeleteEntityType']._options = None
    _ENTITYTYPES.methods_by_name[
        'DeleteEntityType']._serialized_options = b'\202\323\344\223\002+*)/v2/{name=projects/*/agent/entityTypes/*}'
    _ENTITYTYPES.methods_by_name['BatchUpdateEntityTypes']._options = None
    _ENTITYTYPES.methods_by_name[
        'BatchUpdateEntityTypes']._serialized_options = b'\202\323\344\223\002:\"5/v2/{parent=projects/*/agent}/entityTypes:batchUpdate:\001*'
    _ENTITYTYPES.methods_by_name['BatchDeleteEntityTypes']._options = None
    _ENTITYTYPES.methods_by_name[
        'BatchDeleteEntityTypes']._serialized_options = b'\202\323\344\223\002:\"5/v2/{parent=projects/*/agent}/entityTypes:batchDelete:\001*'
