...
class _DefaultProjectRoleEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DefaultProjectRole.V], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    PROJECT_UNSPECIFIED = DefaultProjectRole.V(0)
    """These roles have permissions valid only on a specific project
    unspecified, default value depends on endpoint # TODO
    """

    PROJECT_USER = DefaultProjectRole.V(1)
    """read-only access"""

    PROJECT_EXECUTOR = DefaultProjectRole.V(2)
    """permissions of PROJECT_USER + execution rights (detect intent, extract entities,"""

    PROJECT_DEVELOPER = DefaultProjectRole.V(3)
    """  train, etc)

    permissions of PROJECT_EXECUTOR + CRUD rights
    """

    PROJECT_ADMIN = DefaultProjectRole.V(4)
    """this role can do everything. The creator of a project is set"""

    PROJECT_INACTIVE = DefaultProjectRole.V(5)
...
class _ProjectRoleView:
    V = typing.NewType('V', builtins.int)
class _ProjectRoleViewEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ProjectRoleView.V], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    PROJECT_ROLE_VIEW_UNSPECIFIED = ProjectRoleView.V(0)
    ...
    * ListProjectRoles: FULL
    ...
    PROJECT_ROLE_VIEW_SHALLOW = ProjectRoleView.V(1)
    """only role ID and name fields are populated"""

    PROJECT_ROLE_VIEW_FULL = ProjectRoleView.V(2)
...
class CreateProjectRoleRequest(google.protobuf.message.Message):
    ...
    def role(self) -> global___ProjectRole:
        ...
        """
        pass
    project_role_view: global___ProjectRoleView.V = ...
