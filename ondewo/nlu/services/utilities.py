...
class Utilities(ServicesInterface):
    """
    Exposes the Utilities-related endpoints of ONDEWO NLU services in a user-friendly way.
    ...
    def validate_embedded_regex(self, request: ValidateEmbeddedRegexRequest) -> ValidateEmbeddedRegexResponse:
        response: ValidateEmbeddedRegexResponse = self.stub.ValidateEmbeddedRegex(request, metadata=self.metadata)
        return response
    ...
    def add_training_phrases_from_csv(self, request: AddTrainingPhrasesFromCSVRequest) -> AddTrainingPhrasesResponse:
        response: AddTrainingPhrasesResponse = self.stub.AddTrainingPhrasesFromCSV(request, metadata=self.metadata)
        return response
