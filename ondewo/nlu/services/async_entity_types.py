...
class EntityTypes(AsyncServicesInterface):
    """
    Exposes the EntityTypes-related endpoints of ONDEWO NLU services in a user-friendly way.
    ...
    async def batch_get_entities(self, request: BatchGetEntitiesRequest) -> BatchEntitiesResponse:
        response: BatchEntitiesResponse = await self.stub.BatchGetEntities(request, metadata=self.metadata)
        return response
