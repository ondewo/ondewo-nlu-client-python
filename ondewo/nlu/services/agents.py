...
class Agents(ServicesInterface):
    ...
    def list_project_permissions(self, request: ListProjectPermissionsRequest) -> ListProjectPermissionsResponse:
        response: ListProjectPermissionsResponse = self.stub.ListProjectPermissions(request, metadata=self.metadata)
        return response

    def train_agent(self, request: TrainAgentRequest) -> Operation:
        response: Operation = self.stub.TrainAgent(request, metadata=self.metadata)
        return response

    def build_cache(self, request: BuildCacheRequest) -> Operation:
        response: Operation = self.stub.BuildCache(request, metadata=self.metadata)
        return response

    def export_agent(self, request: ExportAgentRequest) -> Operation:
        response: Operation = self.stub.ExportAgent(request, metadata=self.metadata)
        return response

    def export_benchmark_agent(self, request: ExportBenchmarkAgentRequest) -> Operation:
        response: Operation = self.stub.ExportBenchmarkAgent(request, metadata=self.metadata)
        return response

    def import_agent(self, request: ImportAgentRequest) -> Operation:
        response: Operation = self.stub.ImportAgent(request, metadata=self.metadata)
        return response

    def migrate_agent(self, request: MigrateAgentRequest) -> Operation:
        response: Operation = self.stub.MigrateAgent(request, metadata=self.metadata)
        return response

    def optimize_ranking_match(self, request: OptimizeRankingMatchRequest) -> Operation:
        response: Operation = self.stub.OptimizeRankingMatch(request, metadata=self.metadata)
        return response

    def restore_agent(self, request: RestoreAgentRequest) -> Operation:
        response: Operation = self.stub.RestoreAgent(request, metadata=self.metadata)
        return response
    ...
    def get_sessions_statistics_time_series(
        self,
    ...
    def get_full_text_search_intent(self, request: FullTextSearchRequest) -> FullTextSearchResponseIntent:
        response: FullTextSearchResponseIntent = self.stub.GetFullTextSearchIntent(request, metadata=self.metadata)
        return response
