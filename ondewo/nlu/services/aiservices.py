...
class AiServices(ServicesInterface):
    ...
    def generate_user_says(self, request: GenerateUserSaysRequest) -> GenerateUserSaysResponse:
        response: GenerateUserSaysResponse = self.stub.GenerateUserSays(request, metadata=self.metadata)
        return response

    def generate_responses(self, request: GenerateResponsesRequest) -> GenerateResponsesResponse:
        response: GenerateResponsesResponse = self.stub.GenerateResponses(request, metadata=self.metadata)
        return response

    def get_alternative_sentences(self, request: GetAlternativeSentencesRequest) -> GetAlternativeSentencesResponse:
        response: GetAlternativeSentencesResponse = self.stub.GetAlternativeSentences(request, metadata=self.metadata)
        return response
