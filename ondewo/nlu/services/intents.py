...
class Intents(ServicesInterface):
    ...
    def list_intents(self, request: ListIntentsRequest) -> ListIntentsResponse:
        response: ListIntentsResponse = self.stub.ListIntents(request, metadata=self.metadata)
        return response

    def get_intent(self, request: GetIntentRequest) -> Intent:
        response: Intent = self.stub.GetIntent(request, metadata=self.metadata)
        return response

    def create_intent(self, request: CreateIntentRequest) -> Intent:
        response: Intent = self.stub.CreateIntent(request, metadata=self.metadata)
        return response

    def update_intent(self, request: UpdateIntentRequest) -> Intent:
        response: Intent = self.stub.UpdateIntent(request, metadata=self.metadata)
        return response

    def delete_intent(self, request: DeleteIntentRequest) -> Empty:
        response: Empty = self.stub.DeleteIntent(request, metadata=self.metadata)
        return response

    def batch_update_intents(self, request: BatchUpdateIntentsRequest) -> BatchUpdateIntentsResponse:
        response: BatchUpdateIntentsResponse = self.stub.BatchUpdateIntents(request, metadata=self.metadata)
        return response

    def batch_delete_intents(self, request: BatchDeleteIntentsRequest) -> Operation:
        response: Operation = self.stub.BatchDeleteIntents(request, metadata=self.metadata)
        return response

    def tag_intent(self, request: IntentTagRequest) -> Empty:
        response: Empty = self.stub.TagIntent(request, metadata=self.metadata)
        return response

    def delete_intent_tag(self, request: IntentTagRequest) -> Empty:
        response: Empty = self.stub.DeleteIntentTag(request, metadata=self.metadata)
        return response
    ...
    def list_response_messages(self, request: ListResponseMessagesRequest) -> ListResponseMessagesResponse:
        response: ListResponseMessagesResponse = self.stub.ListResponseMessages(request, metadata=self.metadata)
        return response

    def batch_create_parameters(self, request: BatchCreateParametersRequest) -> BatchParametersStatusResponse:
        response: BatchParametersStatusResponse = self.stub.BatchCreateParameters(request, metadata=self.metadata)
        return response

    def batch_get_parameters(self, request: BatchGetParametersRequest) -> BatchParametersStatusResponse:
        response: BatchParametersStatusResponse = self.stub.BatchGetParameters(request, metadata=self.metadata)
        return response

    def batch_update_parameters(self, request: BatchUpdateParametersRequest) -> BatchParametersStatusResponse:
        response: BatchParametersStatusResponse = self.stub.BatchUpdateParameters(request, metadata=self.metadata)
        return response

    def batch_delete_parameters(self, request: BatchDeleteParametersRequest) -> BatchDeleteParametersResponse:
        response: BatchDeleteParametersResponse = self.stub.BatchDeleteParameters(request, metadata=self.metadata)
        return response
    ...
    def list_training_phrasesof_intents_with_enrichment(
        self,
