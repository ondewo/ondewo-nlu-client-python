...
class _DefaultServerRoleEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DefaultServerRole.V], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    SERVER_UNSPECIFIED = DefaultServerRole.V(0)
    """unspecified server role"""

    SERVER_USER = DefaultServerRole.V(1)
    """read-only access"""

    SERVER_MANAGER = DefaultServerRole.V(2)
    """SERVER_USER's permissions + CRUD of projects and Users"""

    SERVER_ADMIN = DefaultServerRole.V(3)
    """this role can do everything"""

    SERVER_INACTIVE = DefaultServerRole.V(4)
