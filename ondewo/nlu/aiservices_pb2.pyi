...
class ExtractEntitiesRequest(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"language_code",b"language_code",u"parent",b"parent",u"text",b"text"]) -> None: ...
...
class ExtractEntitiesResponse(google___protobuf___message___Message):
    ...
    @property
    def entities(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[global___EntityDetected]: ...

    def __init__(self,
        *,
        entities : typing___Optional[typing___Iterable[global___EntityDetected]] = None,
        text : typing___Optional[typing___Text] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
    ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"entities",b"entities",u"text",b"text"]) -> None: ...
