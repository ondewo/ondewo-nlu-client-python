...
_EXPORTBENCHMARKAGENTRESPONSE_TRAININGPHRASESENTRY = _EXPORTBENCHMARKAGENTRESPONSE.nested_types_by_name[
    'TrainingPhrasesEntry']
...
_FULLTEXTSEARCHRESPONSEENTITYTYPE_ENTITYTYPESEARCHRESULT = _FULLTEXTSEARCHRESPONSEENTITYTYPE.nested_types_by_name[
    'EntityTypeSearchResult']
_FULLTEXTSEARCHRESPONSEENTITY = DESCRIPTOR.message_types_by_name['FullTextSearchResponseEntity']
_FULLTEXTSEARCHRESPONSEENTITY_ENTITYSEARCHRESULT = _FULLTEXTSEARCHRESPONSEENTITY.nested_types_by_name[
    'EntitySearchResult']
_FULLTEXTSEARCHRESPONSEENTITYSYNONYM = DESCRIPTOR.message_types_by_name['FullTextSearchResponseEntitySynonym']
_FULLTEXTSEARCHRESPONSEENTITYSYNONYM_ENTITYSYNONYMSEARCHRESULT = _FULLTEXTSEARCHRESPONSEENTITYSYNONYM.nested_types_by_name[
    'EntitySynonymSearchResult']
_FULLTEXTSEARCHRESPONSEINTENT = DESCRIPTOR.message_types_by_name['FullTextSearchResponseIntent']
_FULLTEXTSEARCHRESPONSEINTENT_INTENTSEARCHRESULT = _FULLTEXTSEARCHRESPONSEINTENT.nested_types_by_name[
    'IntentSearchResult']
_FULLTEXTSEARCHRESPONSEINTENTCONTEXTIN = DESCRIPTOR.message_types_by_name['FullTextSearchResponseIntentContextIn']
_FULLTEXTSEARCHRESPONSEINTENTCONTEXTIN_INTENTCONTEXTINSEARCHRESULT = _FULLTEXTSEARCHRESPONSEINTENTCONTEXTIN.nested_types_by_name[
...
_FULLTEXTSEARCHRESPONSEINTENTCONTEXTOUT_INTENTCONTEXTOUTSEARCHRESULT = _FULLTEXTSEARCHRESPONSEINTENTCONTEXTOUT.nested_types_by_name[
...
_FULLTEXTSEARCHRESPONSEINTENTUSERSAYS_INTENTUSERSAYSSEARCHRESULT = _FULLTEXTSEARCHRESPONSEINTENTUSERSAYS.nested_types_by_name[
...
_FULLTEXTSEARCHRESPONSEINTENTTAGS_INTENTTAGSSEARCHRESULT = _FULLTEXTSEARCHRESPONSEINTENTTAGS.nested_types_by_name[
...
_FULLTEXTSEARCHRESPONSEINTENTRESPONSE_INTENTRESPONSESEARCHRESULT = _FULLTEXTSEARCHRESPONSEINTENTRESPONSE.nested_types_by_name[
...
_FULLTEXTSEARCHRESPONSEINTENTPARAMETERS_INTENTPARAMETERSSEARCHRESULT = _FULLTEXTSEARCHRESPONSEINTENTPARAMETERS.nested_types_by_name[
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _AGENTS.methods_by_name[
        'UpdateAgent']._serialized_options = b'\202\323\344\223\002(2#/v2/{agent.parent=projects/*/agent}:\001*'
    _AGENTS.methods_by_name['GetAgent']._options = None
    _AGENTS.methods_by_name[
        'GetAgent']._serialized_options = b'\202\323\344\223\002\037\022\035/v2/{parent=projects/*/agent}'
    _AGENTS.methods_by_name['DeleteAgent']._options = None
    _AGENTS.methods_by_name[
        'DeleteAgent']._serialized_options = b'\202\323\344\223\002\037*\035/v2/{parent=projects/*/agent}'
    ...
    _AGENTS.methods_by_name[
        'AddUserToProject']._serialized_options = b'\202\323\344\223\0024\"//v2/{parent=projects/*/agent}/users/{user_id=*}:\001*'
    _AGENTS.methods_by_name['RemoveUserFromProject']._options = None
    _AGENTS.methods_by_name[
        'RemoveUserFromProject']._serialized_options = b'\202\323\344\223\0021*//v2/{parent=projects/*/agent}/users/{user_id=*}'
    _AGENTS.methods_by_name['ListUsersInProject']._options = None
    _AGENTS.methods_by_name[
        'ListUsersInProject']._serialized_options = b'\202\323\344\223\002%\022#/v2/{parent=projects/*/agent}/users'
    ...
    _AGENTS.methods_by_name[
        'TrainAgent']._serialized_options = b'\202\323\344\223\002(\"#/v2/{parent=projects/*/agent}:train:\001*'
    _AGENTS.methods_by_name['BuildCache']._options = None
    _AGENTS.methods_by_name[
        'BuildCache']._serialized_options = b'\202\323\344\223\002.\")/v2/{parent=projects/*/agent}:build_cache:\001*'
    _AGENTS.methods_by_name['ExportAgent']._options = None
    _AGENTS.methods_by_name[
        'ExportAgent']._serialized_options = b'\202\323\344\223\002)\"$/v2/{parent=projects/*/agent}:export:\001*'
    _AGENTS.methods_by_name['ExportBenchmarkAgent']._options = None
    _AGENTS.methods_by_name[
        'ExportBenchmarkAgent']._serialized_options = b'\202\323\344\223\0023\"./v2/{parent=projects/*/agent}:export_benchmark:\001*'
    _AGENTS.methods_by_name['ImportAgent']._options = None
    _AGENTS.methods_by_name[
        'ImportAgent']._serialized_options = b'\202\323\344\223\002)\"$/v2/{parent=projects/*/agent}:import:\001*'
    _AGENTS.methods_by_name['OptimizeRankingMatch']._options = None
    _AGENTS.methods_by_name[
        'OptimizeRankingMatch']._serialized_options = b'\202\323\344\223\0029\"4/v2/{parent=projects/*/agent}:optimize_ranking_match:\001*'
    _AGENTS.methods_by_name['RestoreAgent']._options = None
    _AGENTS.methods_by_name[
        'RestoreAgent']._serialized_options = b'\202\323\344\223\002*\"%/v2/{parent=projects/*/agent}:restore:\001*'
    _AGENTS.methods_by_name['GetAgentStatistics']._options = None
    _AGENTS.methods_by_name[
        'GetAgentStatistics']._serialized_options = b'\202\323\344\223\002*\022(/v2/{parent=projects/*/agent}:statistics'
    _AGENTS.methods_by_name['SetAgentStatus']._options = None
    _AGENTS.methods_by_name[
        'SetAgentStatus']._serialized_options = b'\202\323\344\223\002)\"$/v2/{parent=projects/*/agent}:status:\001*'
    _AGENTS.methods_by_name['SetResources']._options = None
    _AGENTS.methods_by_name[
        'SetResources']._serialized_options = b'\202\323\344\223\002,\"\'/v2/{parent=projects/*/agent}:resources:\001*'
    _AGENTS.methods_by_name['DeleteResources']._options = None
    _AGENTS.methods_by_name[
        'DeleteResources']._serialized_options = b'\202\323\344\223\002)*\'/v2/{parent=projects/*/agent}:resources'
    _AGENTS.methods_by_name['ExportResources']._options = None
    _AGENTS.methods_by_name[
        'ExportResources']._serialized_options = b'\202\323\344\223\002,\"\'/v2/{parent=projects/*/agent}:resources:\001*'
    _AGENTVIEW._serialized_start = 9467
    _AGENTVIEW._serialized_end = 9551
    _INITIATIONPROTOCOL._serialized_start = 9553
    _INITIATIONPROTOCOL._serialized_end = 9627
    _REPORTTYPE._serialized_start = 9629
    _REPORTTYPE._serialized_end = 9742
    _REPORTFORMAT._serialized_start = 9744
    _REPORTFORMAT._serialized_end = 9787
    _AGENTSTATUS._serialized_start = 9789
    _AGENTSTATUS._serialized_end = 9828
    ...
    _AGENTS._serialized_start = 9831
    _AGENTS._serialized_end = 14340
